"""
Django settings for practice_management project.
...
ROOT_URLCONF = 'practice_management.urls'
...
WSGI_APPLICATION = 'practice_management.wsgi.application'
...
CRON_CLASSES = [
    "main_app.cron.ClosePracticesCronJob",
]

CRONJOBS = [
    ('0 0 * * *', 'django.core.management.call_command', ['close_registrations']),
]
